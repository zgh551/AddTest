...
# hex_env = Environment(
# CFLAGS = '-romwidth 16 -memwidth 16 -i -o',
# CC = os.path.join(C2000_BIN,'hex2000'),
# CCCOM = '$CC $CFLAGS $TARGET $SOURCES',
# )
# project_hex = hex_env.Program(target='pro.hex',sources='*.out')

# ALL_OBJ = os.listdir('./build')
# main_out = env.Program(ALL_OBJ)
# print(os.listdir('./build'))
# print('obj return')
# print(calculate)
# print('finish')
#env.Object(target = 'mytest.obj',source='./Calculate/src/DumbExample.c')
#env.Program(target = 'mytest.out',source='main.c')
#env.Program('./main.c')
#print(env['TARGET'])
#print(env['SOURCES'])
#env.Program('./Calculate/src/DumbExample.c')
#env.Object('m.obj','./Calculate/src/DumbExample.c')